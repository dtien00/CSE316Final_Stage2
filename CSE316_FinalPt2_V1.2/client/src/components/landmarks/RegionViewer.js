...
const RegionViewer = (props) => {
	...
	const refetchMaps = async (refetch) => {
		...
		if (data) {
            ...
            console.log("LANDMARKS KSS: " + props.activeRegion.landmarks);
    ...
    const addLandmark = async () => {
        ...
        console.log(landmarks);
        console.log(props.activeMap.regions.length);
        console.log(maps);
        setInput({name:''});
    }
    ...
    const editLandmark = async (data) => {
        console.log("Editing landmark");
        console.log(data);
        var newName = window.prompt("New landmark name:");
        console.log(newName);
    }
	...
	return (
        ...
        <label className="region-landmarks-label">Region Landmarks:</label>
            ...
            <LandmarkList landmarks={landmarks} deleteLandmark={deleteLandmark} editLandmark={editLandmark}/>
