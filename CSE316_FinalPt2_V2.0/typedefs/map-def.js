...
const typeDefs = gql `
	...
	extend type Mutation {
		...
		deleteLandmark(map_id: String!, region_id: String!, landmark: Int!): String
		updateMapField(_id: String!, field: String!, value: String!): String
		updateRegionField(mapID: String!, region_id: String!, field: String!, value: String!): [Region]
		...
		editLandmark(map_id: String!, region_id: String!, landmark: Int!, newName: String!): Boolean
		addLandmark(map_id: String!, region_id: String!, landmark: String!): String
	}
	input FieldInput {
		_id: String
		field: String
